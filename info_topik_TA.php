    ...
    <body>
        ...
        <section id="feature">
            <div class="center wow fadeInDown">
                <h2>Topik Tugas Akhir (Berlangsung)</h2>
                <p class="lead">
                    Daftar judul topik tugas akhir yang dapat dijadikan referensi maupun yang sedang berlangsung
                </p>
            </div>
            <div class="container">
                <div class="row contact-wrap">
                    <div class="col-sm-10 col-sm-offset-1 wow fadeInDown" data-wow-delay="300ms">
                        <table cellpadding="0" cellspacing="0" border="0" class= "table table-bordered table-striped" id="tabel1"
                            ...
                            <tbody>
                                <?php
                                include './query/tabel_topik_TA_berlangsung.php';
                                ?>
                            </tbody>
                            <tfoot>
                                <tr>
        ...
        <section id="contact-info">
            <div class="center wow fadeInDown">
                <h2>Topik Tugas Akhir (Referensi)</h2>
                <p class="lead">
                    Daftar judul topik tugas akhir yang dapat dijadikan referensi maupun yang sedang berlangsung
                </p>
            </div>
