                ...
                <div class="col-sm-10 col-sm-offset-1 wow fadeInDown" data-wow-delay="300ms">
                    <table id="table_id" cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-striped"
                        ...
                        <tbody>
                            <?php
                            include "koneksi.php";
                            $tampil = mysql_query("select * from requestpraktikum where id_peminjam = '$_SESSION[kode]'");
                            while ($r = mysql_fetch_array($tampil)) {
                                echo"
                                                    <tr>	
                                                        ...
                                                        <td align=center><a href=detail_peminjaman_praktikum.php?kode_pinjam=$r[kode_pinjam]><button class='btn btn-danger'>Detail</button></a></td>     
                                                    </tr>";
                            }
                            ?>
                        </tbody>
