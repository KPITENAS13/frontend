                            ...
                            <div class="module">
                                ...
                                <div class="module-body table">
                                    <div style="width: 60%; margin-left: 20%;">
                                        <div class="module">
                                            <div class="module-body table">
                                                <form onsubmit="return validateForm()" name="myForm" class="form-horizontal row-fluid" method="post" action="admin/create_absensi.php">
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="pertemuan" placeholder="" class="form-inline">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="date" name="tanggal" placeholder="" class="form-inline">
                                                        </div>
                                                    </div>
