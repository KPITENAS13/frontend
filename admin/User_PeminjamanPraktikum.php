...
<html lang="en">
                                ...
                                <div class=module-body>
                                    <form class=form-horizontal row-fluid name=frm>
                                        <div class=control-group>
                                            ...
                                            <div class=controls>
                                                <input type=text id=basicinput placeholder=$hasil class=span6 disabled>
                                                <input type=hidden id=basicinput value=$hasil class=span6>

                                            </div> </br>
                                            <label class=control-label for=basicinput>Tipe Peminjaman</label>
                                            <div class=controls>
                                                <input type=text id=basicinput placeholder=Praktikum class=span6 disabled>
                                            </div>
                                        </div>
										 <div class=control-group>
											<label class=control-label for=basicinput>Praktikum</label>
											<div class=controls>
												<select tabindex=1 data-placeholder='..Pilih..' class=span6>
										...
										<div class=control-group>
											<label class=control-label for=basicinput>Periode Ajaran</label>
											<div class=controls>
												<div class=input-prepend>
													<span class=add-on>Tahun</span><input class=span2 type=text placeholder='Masukkan Tahun' maxlength=4>      
												</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h1>Daftar Heula</h1>
                    <a href="praktikum.php" class="btn btn-primary">Daftar Praktikum</a>
                </div>
    ...
    <script>
        var $praktikan = '<?php echo $_SESSION['praktikan']; ?>';
        if ($praktikan == "false") {
