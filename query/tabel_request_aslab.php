<?php
include 'koneksi.php';
$q = mysql_query("select nrp, nama from mahasiswa,asisten where mahasiswa.id=asisten.nrp and asisten.approve='R' and praktikum='$_GET[kategori]' and periode='$_GET[periode]'");
