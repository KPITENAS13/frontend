    ...
    <body>
        ...
        <section id="contact-info">
            <div class="center wow fadeInDown">
                ...
                <p class="lead">
                    Detail Peminjaman Alat Inventaris Untuk Praktikum Laboratorium Teknik Informatika ITENAS
                </p>
            </div>
            <div class="row">
                <div class="col-sm-10 col-sm-offset-1 wow fadeInDown" data-wow-delay="300ms">
                    <div class="form-group center">
                        ...
                        echo "
                                    <form class='form-horizontal' role='form' name=frm action='info_peminjaman_praktikum.php' method='post'>
                                        <div class=control-group>
                                            ...
                                            <label class='col-sm-2 control-label' for=basicinput>Praktikum</label>
                                            <div class='col-sm-10 input-group'>
                                                <input type=text id=basicinput placeholder=$r[nama_praktikum] class='form-control' disabled>                                               
                                            </div> </br>
                                            <label class='col-sm-2 control-label' for=basicinput>Periode</label>
                                            <div class='col-sm-10 input-group'>
                                                <input type=text id=basicinput placeholder=$r[periode] class='form-control' disabled>
                                            </div>
                                        </div>
                                        </br></br>
