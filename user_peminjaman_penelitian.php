    ...
    <body>
        ...
        <section id="contact-info">
            <div class="center wow fadeInDown">
                ...
                <p class="lead">
                    Peminjaman Alat Inventaris Untuk Penelitian Laboratorium Teknik Informatika ITENAS
                </p>
            </div>
            <div class="row">
                <div class="col-sm-10 col-sm-offset-1 wow fadeInDown" data-wow-delay="300ms">
                    <div class="form-group center">
                        ...
                        $Code = mysql_query("select * from requestpenelitian order by tanggal_request desc limit 1");
                        ...
                        echo"
                                ...
                                <form class='form-horizontal' role='form' name=frm action='admin/query/userPenelitian.php' method='post'>
