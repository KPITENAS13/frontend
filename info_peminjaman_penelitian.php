    ...
    <body>
        ...
        <section id="contact-info">
            <div class="center wow fadeInDown">
                ...
                <p class="lead">
                    Informasi Peminjaman Alat Untuk Penelitian Laboratorium Teknik Informatika ITENAS
                </p>
            </div>
            <div class="row">
                <div class="col-sm-10 col-sm-offset-1 wow fadeInDown" data-wow-delay="300ms">
                    <table id="table_id" cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-striped"
                        ...
                        <tbody>
                            <?php
                            include "koneksi.php";
                            $tampil = mysql_query("select * from requestpenelitian where id_peminjam = '$_SESSION[kode]'");
